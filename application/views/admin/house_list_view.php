...
<div id="home_admin">
    ...
    <div id="searchcontainer">
                    <form id='searchForm' method='post' action='<?php echo base_url() . "admin/house_list/search"; ?>' >
                        <div id="searchbox">
    ...
    <div id="gamebox_container">
        ...
        <form id='form' method='post' action='<?php echo base_url() . "admin/house_list/delete";?>'
              <div id="gamebox_container">
            ...
            <tbody>
                ...
                ?>
                            ...
                            <td>
                                <? echo anchor('admin/house_list/edit/'.$alist['id'], $alist['id']); ?>
                            </td>
                            <td>
                                <? echo $alist['lastName']; ?>
                            </td>
