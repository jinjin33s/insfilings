<div id="home_admin">
    ...
    -->
     <div id="searchcontainer">
                    <form id='searchForm' method='post' action='<?php echo base_url() . "admin/business_list/search"; ?>' >
                        <div id="searchbox">
...
<form id='form' method='post' action='<?php echo base_url() . "admin/business_list/delete";?>'
    <div id="gamebox_container">
      <table cellpadding="0" cellspacing="0" class="list">
            ...
            <tbody>
                ...
                ?>
                            ...
                            <td>
                                <? echo anchor('admin/business_list/edit/'.$alist['id'], $alist['id']); ?>
                            </td>
                            <td>
                                <? echo $alist['lastName']; ?>
                            </td>
