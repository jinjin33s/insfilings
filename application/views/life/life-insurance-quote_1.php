...
<div id="sub_contentscontainer">
    ...
    <?php if(isset($firstName)){ ?>
        <iframe src="/page/get_view/life-insurance-quote-iframe_1/<? echo $firstName ?>/<? echo $lastName ?>/<? echo str_replace( '@', 'mozzign', $email) ?>/<? echo $phone ?>/<? echo $state ?>/<? echo $sex ?>/<? echo str_replace('$','money',str_replace( ',', 'ast', $coverage)) ?>" style="width:590px;height:550px;" frameborder="0" scrolling="no">
        </iframe>
     <?php }else{ ?>
        <iframe src="/page/get_view/life-insurance-quote-iframe_1" style="width:590px;height:550px;" frameborder="0" scrolling="no"></iframe>
     <?php }?>
