<html>
    <head>
        <script charset="utf-8" type="text/javascript" src="<? echo base_url();?>/jquery-1.4.1.min.js"></script>
        <link href="<? echo base_url();?>css/iframe.css" rel="stylesheet" type="text/css" />
        ...
        <script type="text/javascript" charset="utf-8">
                ...
                $(document).ready(function() {
                    $('#quoteSubmit').click(function () {
                        ...
                        $.ajax({
                            url: "<? echo base_url();?>admin/inquiry_list/life_initiate",
                            type: "GET",
                            data: data ,
                            cache: false,
                            async:false,
            ...
            <script type="text/javascript" charset="utf-8">
                 ...
                 function submitQuote(){
                            ...
                            $.ajax({
                                url: "<? echo base_url();?>admin/inquiry_list/life_initiate_ajax",
                                type: "POST",
                                data: data ,
                                cache: false,
                                async:true,
...
<div style="width:500px; margin-left:40px;" >
    <p><span class="subtitle">Your instant free quote is just a click away!</span></p>
    <form name="quoteForm" method="post" action="http://vitalterm.ebixlife.com/vtweb/vtnettemplate/results.aspx" id="quoteForm">
                        ...
                        <table id="box-table-b-form">                            
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" name="FirstName0" id="FirstName0" value="<?= $firstName?>" style="color: black; width: 100px; " /></td>
                                    <?php }else{ ?>
                                    <td><input type="text" name="FirstName0" id="FirstName0" style="color: black; width: 100px; " /></td>
                                    <?php }?>
                                </tr>
                                <tr>
                                    <td>Last Name:</td>
                                    <?php if(isset($lastName)) { ?>
                                    <td><input type="text" name="LasttName0" id="LasttName0" value="<?= $lastName?>" style="color: black; width: 100px; "/></td>
                                     <?php }else{ ?>
                                    <td><input type="text" name="LasttName0" id="LasttName0" style="color: black; width: 100px; "/></td>
                                     <?php }?>
                                </tr>
                                <tr>
                                    <td>Telephone:</td>
                                    <?php if(isset($phone)) { ?>
                                    <td><input type="text" name="FirstName0" id="FirstName0" value="<?= $phone?>" style="color: black; width: 100px; " /></td>
                                     <?php }else{ ?>
                                    <td><input type="text" name="FirstName0" id="FirstName0"  style="color: black; width: 100px; " /></td>
                                     <?php }?>
                                </tr>
                                <tr>
                                    <td>E-Mail:</td>
                                    <?php if(isset($email)) { ?>
                                    <td><input type="text" name="FirstName0" value="<?= $email?>" style="color: black; width: 100px; " /></td>
                                     <?php }else{ ?>
                                    <td><input type="text" name="FirstName0"  style="color: black; width: 100px; " /></td>
                                     <?php }?>
                                </tr>
                                ...
                                <tr>
                                        ...
                                        <td class="box-table-b-form-answer">
                                            <select name="State" id="State" value='<?= $state; ?>' class="frmControls">
                                ...
                                <tr>
                                    ...
                                    <td class="box-table-b-form-answer">
                                        <select name="Sex" id="Sex" value="<?= $sex?>" class="frmControls">
                                ...
                                <tr>
                                    ...
                                    <td class="box-table-b-form-answer">
                                        <select name="Coverage" id="Coverage" value="<?= $coverage?>" class="frmControls">
                                ...
                                <tr>
                                    <td colspan="2" style="text-align:right; padding-right:0px;">
                                        <input type='image' id="quoteSumit" onclick="submitQuote(); return false" src='http://www.insfilings.com/images/btn_next.png'  width="74" height="30"/><br />
